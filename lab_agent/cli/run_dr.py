"""
Standalone DR conditions runner (invoked via the root-level run_dr.py shim).
...
from ..config import OUTPUT_ROOT, dr_data_path
from ..dr import get_dr_conditions
...
def main() -> None:
    ...
    if end_dt is not None:
        ...
        md = get_dr_conditions(
            data_path, experiment_date,
            explicit_start=experiment_date,
            explicit_end=end_dt,
        )
    else:
        md = get_dr_conditions(data_path, experiment_date, window_hours=hours)
